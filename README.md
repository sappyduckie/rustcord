...
- view contacts
## 4. Add your own profile into your local database, allows the following data:
...
## 7. Encryption of messages and contacts via AES-256, stored locally
...
## 8. Discord functionality: create "servers"
